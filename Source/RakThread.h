...
//ML #include "../DependentExtensions/WinPhone8/ThreadEmulation.h"
//ML using namespace ThreadEmulation;
#endif
...
#define RAK_THREAD_DECLARATION(functionName) void* functionName( void* arguments )
	...
	public:
		...
		*/
#if defined(_WIN32_WCE) || defined(WINDOWS_PHONE_8) || defined(WINDOWS_STORE_RT)
		static int Create(unsigned long __stdcall start_address(void *), void *arglist, int priority = 0); //ML
